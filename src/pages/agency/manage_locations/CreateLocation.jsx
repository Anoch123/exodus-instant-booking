  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        country: locationForm.formData.country,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <Editor
            ...
            onTextChange={(e) => locationForm.updateField('description', e.htmlValue)}
            style={{ height: '320px' }}
            disabled={locationForm.loading}
          />
        </div>
        ...
        <div className="row">
          ...
          <div className="mb-3 col-md-4">
            ...
            <input
              type="text"
              className="form-control"
              value={locationForm.formData.country}
              onChange={(e) => locationForm.updateField('country', e.target.value)}
              required
              disabled={locationForm.loading}
            />
          </div>
